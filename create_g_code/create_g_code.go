...
func main() {
	...
	offsetX := flag.Float64("offset-x", 195, "Build plate X offset in mm")
	offsetY := flag.Float64("offset-y", 195, "Build plate Y offset in mm")
	...
	brim := flag.Bool("brim", false, "Print a brim on the initial layer")
	...
	printTemp := flag.Float64("print-temp", 205, "Printhead temperature in Celsius")
